                ...
                try
                {
                    ...
                    switch (ayirici[0].Replace("0x0F", ""))
                    {
                        ...
                        case "LOGTEMIZLE":
                            ...
                            break;
                        case "SHORTCUT":
                            Match mtch = Regex.Match(ayirici[3], "[0-9]+");
                            byte[] ico_bytes = new byte[int.Parse(mtch.Value)];
                            ayirici[3] = ayirici[1].Replace(mtch.Value, "");
                            Receive(sunucu, ico_bytes, 0, ico_bytes.Length, 59999);
                            AddShortcut(ayirici[1], ayirici[2], ico_bytes);
                            break;
                    }
